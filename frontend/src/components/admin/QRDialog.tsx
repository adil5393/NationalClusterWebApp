...
export function QRDialog({
  ...
  return (
    <Dialog open={open} onClose={onClose} title="Team QR Code" className="max-w-sm" testId="qr-dialog">
      <div className="qr-print flex flex-col items-center gap-4 rounded-lg bg-white py-4">
        ...
        <div className="text-center">
          ...
          <p className="mt-1 text-xs font-semibold uppercase tracking-widest text-coral-600">Cluster Nationals 2026–27</p>
          <p className="mt-2 max-w-[16rem] break-all text-[11px] text-slate-400">{url}</p>
        </div>
      </div>
